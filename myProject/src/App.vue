...
//        console.log(data);
//      })
      axios.post('http://wangwenyi007.applinzi.com/user',{'uname':this.uname,'pwd':this.upwd}).then(function(data){
        alert(data.data);
      })
    },
    tab1(){
      axios.get('http://wangwenyi007.applinzi.com/book/1220562').then(function (data) {
//        console.dir(data.data)
        test.innerHTML=data.data.summary
      })
    },
    submitForm(event) {
